...
void ShaderParticles::init()
{
	...
	D3D12_INPUT_ELEMENT_DESC inputLayout[] =
	{
		...
		{ "COLOR",    1, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 5 * sizeof(float), D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1 },
		{ "TEXCOORD", 2, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, 9 * sizeof(float), D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1 },
	};
